...
SELECT enumlabel 
FROM pg_enum 
WHERE enumtypid = 'file_type_enum'::regtype;


INSERT INTO resources (title, description, file_url, file_type, file_hash, uploaded_by, subject_id)
VALUES 
  ('CS101 Lecture Notes', 'Introduction to Data Structures', 'https://example.com/file1.pdf', 'notes', 'hash123', 1, 1),
  ('Midterm Question Paper 2024', 'Previous year exam paper with solutions', 'https://example.com/file2.pdf', 'question_paper', 'hash456', 2, 1),
  ('Algorithms Reference', 'Quick reference guide and website link', 'https://example.com/file3.pdf', 'reference_link', 'hash789', 3, 2);

  SELECT r.resource_id, r.title, r.description, r.file_url, r.file_type, r.upvotes_count, s.subject_name, d.department_code
FROM resources r
